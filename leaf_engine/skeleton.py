...
from .utils._singleton import SingletonClass


class Skeleton(meta=SingletonClass):
    def __init__(self, db_url: str, db_name: str):
        self.__db_instance = AsyncIOMotorClient(db_url)[
            db_name
        ]
...
# Copied from my Bot's code: https://www.github.com/DroidZed/Z-Butler
#
# class MongoDBConnection(metaclass=SingletonClass):
#     def __init__(self):
#         self.__db_connection = AsyncIOMotorClient(
#             MDB_SRV, serverSelectionTimeoutMS=5000
#         )[DB_NAME]
#
#     @property
